...
namespace Roguelike
{
    ...
    public class Enemy : Character
    {
        ...
        public int XMovementValue = 0;
        public int YMovementValue = 0;
...
//            this.x += this.XMovementValue;
//            this.y += this.YMovementValue;
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                //Console.WriteLine($"T x: {e1.XMovementValue} y:{e1.YMovementValue} next: {map.tiles[e1.x + e1.XMovementValue, e1.y + e1.YMovementValue]} RSide: {map.tiles[e1.RSide, e1.y]} LSide: {map.tiles[e1.LSide, e1.y]} USide: {map.tiles[e1.x, e1.USide]} DSide: {map.tiles[e1.x, e1.USide]}");
                //Console.SetCursorPosition(0, 26);
                //Console.WriteLine($"C x: {e2.XMovementValue} y:{e2.YMovementValue} next: {map.tiles[e2.x + e2.XMovementValue, e2.y + e2.YMovementValue]}");
                //Console.SetCursorPosition(0, 27);
                //Console.WriteLine($"R x: {e3.XMovementValue} y:{e3.YMovementValue} next: {map.tiles[e3.x + e3.XMovementValue, e3.y + e3.YMovementValue]}");
                ...
                while (a < 1)
                {
                    ...
                    {
                        enx1 = rndXe1.Next(1, 38);
                        eny1 = rndYe1.Next(1, 19);
                    }

                    while (map.tiles[e2.x, e2.y] == '#')
                    {
                        enx2 = rndXe2.Next(1, 38);
                        eny2 = rndYe2.Next(1, 19);
                    }

                    while (map.tiles[e3.x, e3.y] == '#')
                    {
                        enx3 = rndXe3.Next(1, 38);
                        eny3 = rndYe3.Next(1, 19);
                    }
                ...
                Console.SetCursorPosition(0, 25);
                Console.WriteLine($"T x: {e1.XMovementValue} y:{e1.YMovementValue} next: {map.tiles[e1.x + e1.XMovementValue, e1.y + e1.YMovementValue]} RSide: {map.tiles[e1.RSide(), e1.y]} LSide: {map.tiles[e1.LSide(), e1.y]} USide: {map.tiles[e1.x, e1.USide()]} DSide: {map.tiles[e1.x, e1.DSide()]} XMVal: {e1.XMovementValue} YMVal: {e1.YMovementValue}");

                //Console.SetCursorPosition(e1.RSide(), e1.y);
                //Console.Write('X');

                //Console.SetCursorPosition(e1.LSide(), e1.y);
                //Console.Write('F');

                //Console.SetCursorPosition(e1.x, e1.USide());
                //Console.Write('K');

                //Console.SetCursorPosition(e1.x, e1.DSide());
                //Console.Write('Z');
                    ...
                    case ConsoleKey.RightArrow:
                        {
                            if (map.tiles[player.GetX() + 1, player.GetY()] == ' ' || map.tiles[player.GetX() + 1, player.GetY()] == '|' || map.tiles[player.GetX() + 1, player.GetY()] == stick.img || map.tiles[player.GetX() + 1, player.GetY()] == cap.img)
                            {
                                ...
                                //    if (map.tiles[e1.x + e1.XMovementValue, e1.y + e1.YMovementValue] == ' ' || map.tiles[e1.x + e1.XMovementValue, e1.y + e1.YMovementValue] == '-' || map.tiles[e1.x + e1.XMovementValue, e1.y + e1.YMovementValue] == '-' || map.tiles[e1.x + e1.XMovementValue, e1.y + e1.YMovementValue] == '|' || map.tiles[e1.x + e1.XMovementValue, e1.y + e1.YMovementValue] == '@')
                                //    {
                                //        e1.EWander(1);
                                //    }

                                //    else if (map.tiles[e3.x + e3.XMovementValue, e3.y + e3.YMovementValue] == '#')
                                //    {
                                //        e1.EWander(4);
                                ...
                                //    if (map.tiles[e2.x + e2.XMovementValue, e2.y + e2.YMovementValue] == ' ' || map.tiles[e2.x + e2.XMovementValue, e2.y + e2.YMovementValue] == '-' || map.tiles[e2.x + e2.XMovementValue, e2.y + e2.YMovementValue] == '-' || map.tiles[e2.x + e2.XMovementValue, e2.y + e2.YMovementValue] == '|' || map.tiles[e2.x + e2.XMovementValue, e2.y + e2.YMovementValue] == '@')
                                //    {
                                //        e2.EWander(2);
                                //    }
                                ...
                                //    if (map.tiles[e3.x + e3.XMovementValue, e3.y + e3.YMovementValue] == ' ' || map.tiles[e3.x + e3.XMovementValue, e3.y + e3.YMovementValue] == '-' || map.tiles[e3.x + e3.XMovementValue, e3.y + e3.YMovementValue] == '-' || map.tiles[e3.x + e3.XMovementValue, e3.y + e3.YMovementValue] == '|' || map.tiles[e3.x + e3.XMovementValue, e3.y + e3.YMovementValue] == '@')
                                //    {
                                //        e3.EWander(3);
                                //    }
